    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card custom-card">
                <div class="card-header"><b>{{ __('Register As a Teacher') }}</b></div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="mobile" class="col-md-3 col-form-label text-md-right">{{ __('Mobile No.') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-3 col-form-label text-md-right">{{ __('Confirm Pass') }}</label>
